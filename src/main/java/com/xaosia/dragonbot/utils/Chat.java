...
public class Chat {
    ...
    public static void sendMessage(CharSequence string, MessageChannel channel) {
        sendMessage(new MessageBuilder().append(string.toString()).build(), channel);
    }

    public static void sendMessage(Message message, MessageChannel channel) {
