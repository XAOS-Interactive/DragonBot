...
public class YouTubeExtractor implements Extractor {
    ...
    @Override
    public void process(String input, Player player, Message message, Guild guild, Member member) throws Exception { //TODO Redo these messages to be more user friendly
        AudioItem item;
        try {
        ...
        if (item instanceof AudioPlaylist) {
            ...
            if (track.getInfo().length >= 900000 && !PermissionsUtil.isTrusted(guild, member)) {
